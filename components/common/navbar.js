...
export default function Navbar() {
  ...
  const dashboard = Cookies.get("token") ;
      ...
      >
        <div className="flex">
          ...
          >
            <img
              ...
              className={`${styles.recLogo} h-12 mr-8`}
              alt="Flowbite Logo"
            />
          </Link>
          <MegaDropdown />
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <Link href={"/dashboard"}>
            <button
              type="button"
              className={`${styles.loginBtn} text-white ml-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}
            >
              Dashboard
            </button>
          </Link> :
