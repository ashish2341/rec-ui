...
const SearchBar = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative mr-5">
      ...
      <button
        type="submit"
        className={`${styles.NavBarSearchButton} absolute top-0 end-0 text-white bg-blue-700 h-30 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-1.5 py-2  mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800`}
      >
        <i className={`${styles.NavBarSearchIcon} bi bi-search`}></i>
      </button>
    </form>
  );
};
