...
export default function ProjectDetailsForm({ valueForNext, valueForNextPage }) {
  ...
  useEffect(() => {
    ...
    if (localStorageProjectData) {
      console.log("if function called ", localStorageProjectData.isEnabled);
      setPropertyType(localStorageProjectData.propertyType || "");
      setFacing(localStorageProjectData.facing || "");
      setIsEnabled(
        localStorageProjectData.isEnabled === true
          ? true
          : localStorageProjectData.isEnabled === undefined
          ? null
          : false
      );
      setIsExclusive(
        localStorageProjectData.isExclusive === true
          ? true
          : localStorageProjectData.isExclusive === undefined
          ? null
          : false
      );
      setIsFeatured(
        localStorageProjectData.isFeatured === true
          ? true
          : localStorageProjectData.isFeatured === undefined
          ? null
          : false
      );
      setIsNew(
        localStorageProjectData.isNew === true
          ? true
          : localStorageProjectData.isNew === undefined
          ? null
          : false
      );
      setAvailableUnits(localStorageProjectData.availableUnits || "");
      setReraNumber(localStorageProjectData.reraNumber || "");
      setProjectStatus(localStorageProjectData.projectStatus || "");
    }
  }, []);
