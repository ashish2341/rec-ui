...
export default function Property(params) {
  ...
  const getAllPropertiesByBuilder = async (showValue) => {
    ...
    let properties = await GetPropertyBybuilderApi(
      page,
      searchData,
      showValue || showValue === false ? showValue : showValue1,
      type,
      todayProperty
    );
    if (properties?.resData?.success == true) {
                      ...
                      <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div className={`flex w-full ${styles.cardContent}`}>
                          ...
                          >
                            ...
                            <div className="mb-4">
                              <div
                                className={`${styles.heroSectionBottomMain}`}
                              >
                                <div
                                  className={`${styles.heroSectionBottomBox}`}
                                >
                                  <div
                                    className={`${styles.BottomBoxcontenet}`}
                                  >
                                    <h2
