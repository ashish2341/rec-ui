                            ...
                            {item?.IsEnabled && (
                              <Link href={`/propertyDetail/${item._id}`}>
                               <div className={`${styles.previewIconContainer}`}>
                                <i className={`font-bold text-xl text-blue-600 dark:text-blue-500 bi bi-box-arrow-up-right ${styles.previewIcon} `}></i>
                               <div className={`${styles.hoverText}`}>Preview</div>
                             </div>
                             </Link>
