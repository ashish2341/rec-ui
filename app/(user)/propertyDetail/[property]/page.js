              ...
              <div className={`${styles.overviewBox}`}>
                ...
                <div className={`${styles.overviewBoxBottomMain}`}>
                  ...
                  <button
                    ...
                    className="text-grey border border-gray-600 bg-white-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-6 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Download Brochure
                  </button>
                </div>
